    ...
    <div className="container mx-auto max-w-4xl px-4 py-5">
      ...
      <div className="mt-12 space-y-12">
        <section>
          ...
          <p className="mt-4">
            Welcome to Hazrat Ali Problem Solving. By accessing and using this website, you
        ...
        <section>
          ...
          <p className="mt-4">
            All content published on Hazrat Ali Problem Solving is protected by copyright
            law. Users may not reproduce, distribute, or create derivative works
        ...
        <section>
          <h2 className="text-2xl font-semibold">
            4. User Registration & Account Terms
          </h2>
          <p className="mt-4">
            Users must provide accurate information when creating an account.
            Accounts found to contain false information may be terminated
            without notice.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-semibold">
            5. Code Snippet Usage Policy
          </h2>
          <p className="mt-4">
            Code snippets provided on Hazrat Ali Problem Solving are available for
            educational purposes. Users may use these snippets in their projects
        ...
        <section>
          <h2 className="text-2xl font-semibold">
            6. Comment Policy & Community Guidelines
          </h2>
          <ul className="mt-4 list-inside list-disc space-y-2">
        ...
        <section>
          ...
          <p className="mt-4">
          Hazrat Ali Problem Solving is not liable for any damages arising from the use or
        ...
        <section>
          ...
          <p className="mt-4">
            ...
            <a
              href="mailto: hazrataliein@gmail.com"
